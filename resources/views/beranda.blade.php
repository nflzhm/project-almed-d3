...
<head>
    ...
    /* REVISI: Lebar dropdown Layanan diatur menjadi 2 kolom proporsional */
    .drop-menu-layanan { 
        min-width: 420px; 
    ...
    .section-epasien { background: #fff; padding: 55px 0; }
.epasien-inner { max-width: 720px; margin: 0 auto; text-align: center; }
.epasien-title { font-size: 24px; font-weight: 900; color: #000000; }
.epasien-underline { width: 80px; height: 3px; background: #1C145C; margin: 8px auto 18px; border-radius: 10px; }
.epasien-desc { line-height: 1.8; font-size: 15px; color: #333; margin-bottom: 26px; }
.epasien-btn-group { display: flex; align-items: center; justify-content: center; gap: 12px; flex-wrap: wrap; }
.btn-epasien-cta { display: inline-flex; align-items: center; gap: 8px; padding: 12px 26px; border-radius: 50px; background: #1C145C; color: #fff !important; text-decoration: none !important; font-size: 14px; font-weight: 600; box-shadow: 0 8px 20px rgba(28,20,92,.25); transition: .2s; }
.btn-epasien-cta:hover { background: #2a1e8a; transform: translateY(-1px); }
.btn-epasien-cta .ext-icon { font-size: 12px; opacity: .8; }
.btn-epasien-mjkn { display: inline-flex; align-items: center; gap: 8px; padding: 12px 26px; border-radius: 50px; background: #fff; color: #1C145C !important; text-decoration: none !important; font-size: 14px; font-weight: 600; border: 1.5px solid #1C145C; transition: .2s; }
.btn-epasien-mjkn:hover { background: #1C145C; color: #fff !important; transform: translateY(-1px); box-shadow: 0 8px 20px rgba(28,20,92,.2); }
.btn-epasien-mjkn .ext-icon { font-size: 12px; opacity: .8; }
...
">
    ...
    <div style="position:absolute; bottom:-2px; left:0; width:100%; line-height:0;">
        <svg viewBox="0 0 1440 120" xmlns="http://www.w3.org/2000/svg" style="display:block;">
            <path fill="#1C145C" d="M0,64L80,69.3C160,75,320,85,480,80C640,75,800,53,960,48C1120,43,1280,53,1360,58.7L1440,64L1440,120L1360,120C1280,120,1120,120,960,120C800,120,640,120,480,120C320,120,160,120,80,120L0,120Z"></path>
        </svg>
    </div>
</section>
    ...
    <div class="container-fluid px-2">
        <div class="row text-center g-0">
            ...
            <div class="col-6 col-md-3 d-flex flex-column align-items-center py-3">
                ...
                <h4 class="fw-bold mt-2 mb-0">33</h4>
    ...
    <div id="adCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
        <div class="carousel-inner m-0 p-0">
            ...
            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                <img src="{{ asset('storage/'.$item->gambar) }}" class="d-block w-100" style="height:auto; display:block;">
            </div>
            @endforeach
        </div>
    </div>
...
<section class="section-epasien">
    <div class="container">
        <div class="epasien-inner">
            ...
            <div class="epasien-btn-group">
                <a href="https://epasien.allammedica.com/" target="_blank" rel="noopener" title="Pendaftaran Online Pasien - e-Pasien RSU Allam Medica" class="btn-epasien-cta">
                    <i class="bi bi-calendar2-plus-fill"></i>
                    <span>Daftar Online Sekarang</span>
                    <i class="bi bi-box-arrow-up-right ext-icon"></i>
                </a>
                <a href="https://play.google.com/store/apps/details?id=app.bpjs.mobile&pcampaignid=web_share" target="_blank" rel="noopener" title="buka untuk pasien bpjs" class="btn-epasien-mjkn">
                    <i class="fa-solid fa-mobile-screen-button"></i>
                    <span>Daftar melalui MJKN</span>
                    <i class="bi bi-box-arrow-up-right ext-icon"></i>
                </a>
            </div>
        </div>
...
<section style="background:#fff; padding:50px 0;">
    <div class="container">
        <div class="text-center mb-4">
            ...
            <div style="width:80px; height:3px; background:#1C145C; margin:8px auto 0; border-radius:10px;"></div>
        </div>
...
<style>
.section-dokter, .section-media { position:relative; overflow:hidden; }
.section-dokter .container, .section-media .container { position:relative; z-index:2; }
.section-dokter::before{ content:''; position:absolute; left:-120px; top:40px; width:360px; height:360px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.05; pointer-events:none; z-index:1; }
.section-dokter::after{ content:''; position:absolute; right:-110px; bottom:30px; width:320px; height:320px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.04; pointer-events:none; z-index:1; }
.section-media::before{ content:''; position:absolute; right:-120px; top:20px; width:380px; height:380px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.05; pointer-events:none; z-index:1; }
.section-media::after{ content:''; position:absolute; left:-100px; bottom:20px; width:300px; height:300px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.04; pointer-events:none; z-index:1; }
</style>
...
<section class="section-dokter" style="background:#fff; padding:50px 0;">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 col-12 dokter-item" style="{{ $index >= 12 ? 'display:none;' : '' }}">
                <div style="display:flex; gap:15px; padding:18px; border:1px solid #eee; border-radius:28px; align-items:center; height:100%; background:#fff; transition:.3s;"
                onmouseover="this.style.boxShadow='0 14px 35px rgba(0,0,0,.08)'; this.style.transform='translateY(-4px)';"
                onmouseout="this.style.boxShadow='none'; this.style.transform='translateY(0)';">
                    @if($item->foto)
                        <img src="{{ asset('uploads/dokter/'.$item->foto) }}" loading="lazy" alt="{{ $item->nama }}" style="width:95px; height:95px; border-radius:50%; object-fit:cover; border:3px solid #1C145C; flex-shrink:0;">
                    @else
                        <div style="width:95px; height:95px; border-radius:50%; background:#e2e8f0; display:flex; align-items:center; justify-content:center; font-size:30px; font-weight:700; color:#475569; border:3px solid #1C145C; flex-shrink:0;">
                            {{ strtoupper(substr($item->nama,0,1)) }}
                        </div>
                    @endif
                    <div style="display:flex; flex-direction:column; justify-content:space-between; height:100%; width:100%;">
                        <div>
                            <h5 class="fw-bold mb-1" style="font-size:16px; line-height:1.4; color:#1C145C;">{{ $item->nama }}</h5>
                            <small style="color:#64748b; font-size:13px;">{{ $item->spesialis }}</small>
                        </div>
                        <a href="{{ route('jadwaldokter') }}" style="margin-top:12px; display:inline-block; padding:8px 16px; background:#1C145C; color:white; text-decoration:none; border-radius:999px; font-size:12px; font-weight:600; width:max-content; transition:.3s;"
                           onmouseover="this.style.background='#31248f';" onmouseout="this.style.background='#1C145C';">
                            Cek Jadwal
                        </a>
                    </div>
                </div>
        ...
        <div class="text-center mt-5">
            <button id="loadMoreDokter" style="border:none; background:#1C145C; color:#fff; padding:12px 28px; border-radius:999px; font-weight:600; transition:.3s;"
                    onmouseover="this.style.background='#31248f'; this.style.transform='translateY(-2px)';"
                    onmouseout="this.style.background='#1C145C'; this.style.transform='translateY(0)';">
...
<section class="section-media" style="padding:70px 0; background: linear-gradient(to bottom, #ffffff 0%, #fdfcf8 20%, #f5f2e7 50%, #fdfcf8 80%, #ffffff 100%);">
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body d-flex flex-column text-center">
                        ...
                        <div class="mt-auto">
                            <a href="{{ url('/berita/'.$item->slug) }}" class="btn btn-sm" style="background:#1C145C; color:#fff; border-radius:20px; padding:6px 14px;">Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-5">
            <a href="/berita" style="display:inline-block; padding:10px 20px; background:#1C145C; color:#fff; text-decoration:none; border-radius:20px; font-size:14px; transition:0.3s ease;"
...
/* Pause animasi saat cursor berada di slider */
...
<section style="background:#fff; padding:50px 0;">
    ...
    <div class="partner-slider">
        <div class="partner-track">
            <div class="partner-item"><img src="{{ asset('images/beranda/logo0.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo1.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo2.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo3.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo4.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo5.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo6.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo7.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo8.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo9.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo10.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo11.webp') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo12.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo13.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo14.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo15.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo16.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo17.webp') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo18.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo19.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo20.webp') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo21.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo22.png') }}"></div>
            <div class="partner-item"><img src="{{ asset('images/beranda/logo23.png') }}"></div>
...
<style>
/* ============================================================
   CSS WHATSAPP BUTTON (SUDAH DIKEMBALIKAN & DISESUAIKAN)
============================================================ */
...
@media(max-width: 575px) {
    .wa-float-btn { right: 20px; bottom: 112px; width: 60px; height: 60px; } /* Bottom dinaikkan agar tidak tertutup floating bar */
    .wa-float-icon { font-size: 26px; }
    .wa-tooltip { right: 78px; bottom: 122px; max-width: min(72vw, 240px); padding: 11px 12px; }
...
/* ===============================
   MOBILE VERSION & WA BUTTON ADJUSTMENT
================================= */
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-footer border-0 justify-content-center gap-2 pb-4 pt-3">
                ...
                <a href="tel:+6285290273097" class="btn-telepon">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ─── Load More Dokter Logic ─── */
    let currentItems = 12;
    const items = document.querySelectorAll('.dokter-item');
    const btnLoadMore = document.getElementById('loadMoreDokter');
    ...
    function openWaModal() {
        ...
        // biarkan overflow body default saat wa-modal aktif jika tidak ingin bentrok dg hal lain
    }
...
/* ─── Fungsi Modal Kedaruratan (IGD) Beranda ─── */
