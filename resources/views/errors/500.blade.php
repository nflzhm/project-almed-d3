...
<head>
    ...
    <title>500 - Server Error | RSU Allam Medica</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap {
            ...
            background: linear-gradient(135deg, #b07d2e, #7a5318);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
            margin: -48px auto 24px;
            box-shadow: 0 8px 24px rgba(176,125,46,0.3);
        }
        .icon-wrap svg {
        ...
        .divider {
            width: 40px;
            height: 2px;
            background: linear-gradient(90deg, #b07d2e, transparent);
            margin: 0 auto 28px;
            border-radius: 2px;
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 24px rgba(176,125,46,0.4);
        }
...
<body>
    ...
    <div class="card">
        ...
        <div class="badge">
            ...
            <span class="badge-text">Server Error</span>
        </div>

        <h1 class="title">Terjadi kesalahan<br>pada server</h1>

        <div class="divider"></div>

        <p class="desc">
            Server sedang mengalami gangguan sementara. Tim teknis kami sedang menangani masalah ini.
