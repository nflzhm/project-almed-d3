...
/* ============================================================
   BODY — layout sidebar kategori (sticky) + list FAQ
============================================================ */
.faq-body {
    padding: 64px 0 80px;
    background: #fff;
...
.faq-search {
    ...
    box-shadow: 0 2px 10px rgba(28,20,92,.05);
...
/* Layout: sidebar kategori sticky + konten */
...
.faq-cat-btn {
    ...
    color: #64748b; cursor: pointer; margin-bottom: 3px; transition: all .2s;
...
.faq-cat-btn .cat-count {
    ...
    background: rgba(28,20,92,.1); color: #1C145C;
...
/* Accordion item — style "+" berputar seperti referensi */
.faq-list { display: flex; flex-direction: column; gap: 12px; }
.faq-item {
    background: #fff; border-radius: 16px; overflow: hidden;
    border: 1.5px solid #eef1f7; box-shadow: 0 2px 10px rgba(28,20,92,.04);
    transition: border-color .25s, box-shadow .25s;
}
.faq-item.open { border-color: #0ea5e9; box-shadow: 0 10px 28px rgba(14,165,233,.12); }
.faq-q {
    display: flex; align-items: flex-start; justify-content: space-between; gap: 16px;
    padding: 19px 22px; cursor: pointer; background: none; border: none; width: 100%;
...
.faq-q-icon {
    ...
    background: rgba(28,20,92,.06); color: #1C145C;
...
.faq-toggle {
    ...
    font-size: 15px; font-weight: 700; color: #94a3b8; transition: all .3s ease;
}
...
.faq-a {
    padding: 0 22px 22px 71px;
    font-size: 13.5px; color: #64748b; line-height: 1.85;
}
...
/* CTA bawah — contact box */
.faq-cta {
    margin-top: 40px; border-radius: 22px;
    background: #f4f6fb; border: 1.5px solid #e4e9f4;
    padding: 40px 30px; text-align: center; position: relative; overflow: hidden;
}
.faq-cta::before {
    content: ''; position: absolute; right: -60px; top: -60px;
    width: 220px; height: 220px; border-radius: 50%;
    background: radial-gradient(circle, rgba(28,20,92,.06), transparent 65%); pointer-events: none;
}
...
.faq-cta-btn {
    ...
    padding: 12px 24px; border-radius: 50px; background: #1C145C; color: #fff;
    font-size: 13.5px; font-weight: 700; text-decoration: none;
    transition: transform .2s, box-shadow .2s;
    box-shadow: 0 10px 24px rgba(28,20,92,.22);
}
.faq-cta-btn:hover { transform: translateY(-2px); color: #fff; box-shadow: 0 14px 30px rgba(28,20,92,.28); }
.faq-cta-btn-ghost {
    display: inline-flex; align-items: center; gap: 8px;
    padding: 12px 24px; border-radius: 50px; background: #fff; color: #1C145C;
    border: 1.5px solid #dbe1ee; font-size: 13.5px; font-weight: 700; text-decoration: none;
...
@media(max-width:991px) { .navbar-float-wrap { top:38px;padding:4px 12px; } .navbar-float { border-radius:26px;padding:8px 14px; } .nav-links,.nav-cta { display:none; } .nav-burger { display:flex; } }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ─── FAQ Kategori Filter (sidebar sticky) ─── */
