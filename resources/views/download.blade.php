...
@media(max-width:991px) {
    body { padding-top: calc(38px + 64px); } /* Mengikuti aturan untuk layar kecil di template awal atau disesuaikan dengan kebutuhan (disini saya biarkan body styling default download) */
...
/* ================================================================
   BODY OVERRIDE (halaman download)
================================================================ */
