...
<head>
    <meta charset="UTF-8">
    <title>RSU Allam Medica - Karir</title>
    ...
    overflow-x: hidden;
    padding-top: 38px; /* <--- Ubah bagian ini (sebelumnya: calc(38px + 70px)) */
    position: relative;
    margin: 0; /* Tambahkan margin 0 untuk memastikan tidak ada spasi bawaan browser */
}
