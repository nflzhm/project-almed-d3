...
<head>
    ...
    body {
        ...
        background: #ffffff;
        overflow-x: hidden;
        padding-top: 38px; /* Memastikan hero nempel pas di bawah topbar */
        position: relative;
    }
    ...
    .kontak-form-title, .bs-form-title { font-family: 'GothamBlack', sans-serif !important; font-size: 19px; color: #FEFCF1; margin-bottom: 16px; line-height: 1.2; }
    ...
    /* ============================================================
       BREADCRUMB & ARTIKEL DETAIL CONTENT
    ============================================================ */
    section { position: relative; z-index: 1; }
    .breadcrumb-wrap { background: transparent; border-bottom: none; padding: 100px 0 10px; margin-top: 0; position: relative; z-index: 1; }
    .breadcrumb { display: flex; align-items: center; flex-wrap: wrap; margin-bottom: 0; }
    .breadcrumb-item { display: flex; align-items: center; font-size: 13px; line-height: 1.5; }
    .breadcrumb-item a, .breadcrumb-item.active { display: inline-flex; align-items: center; font-size: 13px; line-height: 1.5; }
    .breadcrumb-item a { color: #1C145C; text-decoration: none; }
    .breadcrumb-item.active { color: #888; }
    .breadcrumb-item + .breadcrumb-item::before { display: inline-flex; align-items: center; color: #aaa; margin: 0 6px; }
    
    .detail-hero { width: 100%; height: auto; max-height: none; object-fit: contain; display: block; border-radius: 16px; margin-bottom: 28px; box-shadow: 0 8px 30px rgba(0,0,0,0.10); }

    .article-card { background: #fff; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.06); padding: 40px 48px; margin-bottom: 40px; }
    ...
    .meta-badge { background: #EEF0FF; color: #1C145C; border-radius: 20px; padding: 4px 14px; font-size: 12px; font-weight: 600; letter-spacing: 0.5px; }
    .meta-date { color: #888; font-size: 13px; }
    .meta-date i { margin-right: 5px; }

    .article-title { font-size: 30px; font-weight: 800; color: #1C145C; line-height: 1.3; margin-bottom: 20px; }
    @media (max-width: 768px) { .article-title { font-size: 22px; } }

    .article-divider { border: none; border-top: 2px solid #EEF0FF; margin: 24px 0; }

    .article-content { font-size: 15.5px; color: #333; line-height: 1.85; }
    .article-content p { margin-bottom: 16px; }
    .article-content img { max-width: 100%; border-radius: 10px; margin: 10px 0; }

    .share-wrap { background: #f5f6ff; border-radius: 14px; padding: 18px 24px; display: flex; align-items: center; flex-wrap: wrap; gap: 12px; margin-top: 36px; }
    .share-label { font-size: 13px; font-weight: 700; color: #1C145C; }
    .share-btn { display: inline-flex; align-items: center; gap: 6px; padding: 7px 16px; border-radius: 20px; font-size: 13px; font-weight: 600; text-decoration: none; transition: opacity 0.2s; }
    ...
    .btn-back { display: inline-flex; align-items: center; gap: 8px; background: #1C145C; color: #fff; border-radius: 20px; padding: 9px 22px; font-size: 13px; font-weight: 600; text-decoration: none; transition: background 0.2s; margin-bottom: 28px; }
    .btn-back:hover { background: #150f4a; color: #fff; }

    .related-title { font-size: 20px; font-weight: 800; color: #1C145C; margin-bottom: 20px; }
    .related-card { border: 1px solid #eee; border-radius: 16px; overflow: hidden; background: #fff; height: 100%; transition: box-shadow 0.25s, transform 0.25s; }
    .related-card:hover { box-shadow: 0 8px 24px rgba(28,20,92,0.10); transform: translateY(-3px); }
    .related-card img { width: 100%; height: 160px; object-fit: cover; display: block; }
    .related-card-body { padding: 14px 16px; text-align: center; }
    .related-card-body h6 { font-size: 14px; font-weight: 700; color: #1C145C; margin-bottom: 8px; }
    .related-card-body p { font-size: 12px; color: #666; margin-bottom: 10px; }
    .related-card-body a { display: inline-block; padding: 5px 14px; background: #1C145C; color: white; text-decoration: none; border-radius: 20px; font-size: 12px; }
    .related-card-body a:hover { background: #150f4a; }

    .section-ornamen { position: relative; overflow: hidden; }
    .section-ornamen .orn { position: absolute; background-size: contain; background-repeat: no-repeat; background-image: url('{{ asset("images/beranda/ornamen.png") }}'); pointer-events: none; z-index: 0; }
    .section-ornamen .orn-1 { right: -100px; top: 60px; width: 420px; height: 420px; opacity: 0.05; }
    .section-ornamen .orn-2 { left: -120px; top: 40%; width: 360px; height: 360px; opacity: 0.04; }
    .section-ornamen .orn-3 { right: -60px; bottom: 100px; width: 280px; height: 280px; opacity: 0.03; }
    .section-ornamen > .container { position: relative; z-index: 1; }

    /* ============================================================
       ORNAMEN HALAMAN BERITA (LIST)
    ============================================================ */
    .berita-list-section{ position:relative; overflow:hidden; background:#fff; }
    .berita-list-section::before{ content:''; position:absolute; left:-120px; top:80px; width:340px; height:340px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.04; pointer-events:none; z-index:1; }
    .berita-list-section::after{ content:''; position:absolute; right:-140px; bottom:80px; width:420px; height:420px; background:url('{{ asset("images/beranda/ornamen.png") }}') center/contain no-repeat; opacity:.05; pointer-events:none; z-index:1; }
    .berita-list-section .container{ position:relative; z-index:2; }
    ...
    .berita-section{ padding:85px 0 20px; background:#fff; }
    .berita-wrap{ max-width: 900px; text-align: left; }
    .berita-label{ font-size:12px; font-weight:600; color:#888; letter-spacing:2px; text-transform:uppercase; }
    .berita-heading{ font-size:32px; font-weight:800; color:#1C145C; margin:10px 0; }
    .berita-desc{ font-size:14px; color:#444; margin:0; padding:0; line-height:1.6; white-space: normal; display: block; width: 100%; }

    /* ============================================================
       PAGINATION BERITA
    ============================================================ */
    .berita-pagination { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 24px 40px 40px; border-top: 1px solid #e8edf5; background: #fff; }
    ...
    @media (max-width: 576px) {
        ...
        .pag-btn { min-width: 34px; height: 34px; font-size: 12px; border-radius: 8px; }
    }
...
{{-- ============================================================
     KONTEN HALAMAN (BERITA LIST / DETAIL)
============================================================ --}}
@if(isset($berita) && isset($berita->judul))
    ...
    <section class="section-ornamen" style="
        padding: 40px 0 60px;
        background: linear-gradient(to bottom, #ffffff 0%, #fefefd 5%, #fdfcf6 15%, #faf8ee 30%, #f7f5e8 50%, #fdfcf6 80%, #ffffff 100%) !important;
    ">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-12">
                    ...
                    <div class="article-card">
                        @if($berita->gambar)
                        <img src="{{ asset('storage/' . $berita->gambar) }}" alt="{{ $berita->judul }}" class="detail-hero">
                        @endif
                        ...
                        <div class="share-wrap">
                            ...
                            <a href="https://wa.me/?text={{ urlencode($berita->judul . ' ' . request()->url()) }}" target="_blank" class="share-btn share-wa">
                ...
                <div class="col-lg-4 col-12 mt-4 mt-lg-0">
                    <div style="background:#fff; border-radius:16px; box-shadow: 0 4px 20px rgba(0,0,0,0.06); padding: 24px; position: sticky; top: 110px;">
                        ...
                        <a href="{{ url('/berita/' . $lain->slug) }}" style="text-decoration:none;">
                            <div style="display:flex; gap:12px; align-items:flex-start; padding: 12px 0; border-bottom: 1px solid #f0f0f0;">
                                <img src="{{ asset('storage/' . $lain->gambar) }}" style="width:70px; height:70px; object-fit:cover; border-radius:10px; flex-shrink:0;">
                                <div>
                                    <p style="font-size:13px; font-weight:700; color:#1C145C; margin:0 0 5px;">{{ Str::limit($lain->judul, 60) }}</p>
                                    <span style="font-size:11px; color:#999;"><i class="bi bi-calendar3 me-1"></i>{{ \Carbon\Carbon::parse($lain->created_at)->translatedFormat('d M Y') }}</span>
                                </div>
                            </div>
                        </a>
                        @endforeach
                        <div class="text-center mt-3">
                            <a href="{{ url('/berita') }}" style="font-size:13px; color:#1C145C; font-weight:600; text-decoration:none;">
...
@else
    <!-- TAMPILAN LIST BERITA -->
    <section class="berita-section">
        <div class="container">
            <div class="berita-wrap">
                <span class="berita-label">Buletin Allam Medica</span>
                <h2 class="berita-heading">Informasi Kesehatan Terpercaya untuk Anda</h2>
                <p class="berita-desc">
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-3 col-12">
                    <div style="border:1px solid #eee; border-radius:20px; overflow:hidden; background:#fff; height:100%;">
                        <img src="{{ asset('storage/'.$item->gambar) }}" style="width:100%; height:auto; display:block;">
                        <div style="padding:15px; text-align:center;">
                            <h6 class="fw-bold">{{ $item->judul }}</h6>
                            <p style="font-size:13px; color:#666;">{{ \Illuminate\Support\Str::limit($item->deskripsi, 95) }}</p>
                            <a href="{{ url('/berita/'.$item->slug) }}" style="display:inline-block; margin-top:8px; padding:6px 12px; background:#1C145C; color:white; text-decoration:none; border-radius:20px; font-size:12px;">
                                Baca Selengkapnya
                            </a>
                        </div>
                    </div>
...
<!-- ============================================================
     JAVASCRIPT: NAVBAR, BREADCRUMB SHARE, WA MODAL
============================================================ -->
<script>
