...
.kontak-map-caption i { color: #1C145C; font-size: 11px; }
    ...
    .breadcrumb-wrap { background: transparent; border-bottom: none; padding: 30px 0 5px; margin-top: 15px; position: relative; z-index: 1; }
...
.footer-rsu .footer-ornament{
    ...
    background-image:url('{{ asset("images/beranda/ornamen.png") }}'); background-size:contain; background-repeat:no-repeat; background-position:center; pointer-events:none; z-index:0;
}
