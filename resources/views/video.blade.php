...
<head>
    ...
    .kontak-form-title { font-size: 19px; color: #FEFCF1; margin-bottom: 16px; line-height: 1.2; }
    ...
    .bs-form-card > *:not(.form-ornament) { position:relative; z-index:1; }
    ...
    .video-section { padding:80px 0 40px;background:#fff; }
    ...
    @media(max-width:991px){
        ...
        .video-section         { padding:60px 0 30px; } /* Menyesuaikan jarak mobile */
    }
...
<!-- ============================================================
     JAVASCRIPT: NAVBAR, BOTTOM SHEET, WA MODAL
============================================================ -->
<script>
